...
def test_cross_family_probe_budget_guard_blocks_repeated_unsuccessful_probes() -> None:
    ...
    assert budget_guarded_candidate[3]["cross_family_probe_budget_limit"] == 2
...
def test_cross_family_probe_preference_applies_when_recent_success_exists() -> None:
    ...
    assert allowed_candidate[3]["cross_family_probe_budget_limit"] == 3
    assert allowed_candidate[3]["cross_family_probe_budget_remaining"] == 1
...
def test_cross_family_probe_preference_falls_back_when_quality_weighted_bonus_budget_is_spent() -> None:
    ...
    engine.decision_log = [
        _cross_family_probe_record(
            decision_id="cross_probe_successful_budget",
            source_id="historical_probe_success_budget",
            source_family_snapshot="adhd_aware_support+language_sensitive_support",
            target_id="historical_target_success_budget",
            target_family_snapshot="adhd_aware_support",
            observed_outcome_score=0.82,
            effective=True,
            timestamp=now - timedelta(hours=1),
        ),
        _cross_family_probe_record(
            decision_id="cross_probe_retry_a",
            source_id="historical_probe_retry_a",
            source_family_snapshot="adhd_aware_support+language_sensitive_support",
            target_id="historical_target_retry_a",
            target_family_snapshot="adhd_aware_support",
            observed_outcome_score=0.2,
            effective=False,
            timestamp=now - timedelta(hours=2),
        ...
        _cross_family_probe_record(
            decision_id="cross_probe_retry_b",
            source_id="historical_probe_retry_b",
            source_family_snapshot="adhd_aware_support+language_sensitive_support",
            target_id="historical_target_retry_b",
            target_family_snapshot="adhd_aware_support",
            observed_outcome_score=0.18,
            effective=False,
...
def test_cross_family_probe_preference_requires_fresh_success_signal() -> None:
    engine = CalibrationEngine(min_samples_for_calibration=999)
    now = datetime.now(UTC)
    ...
    engine.decision_log = [
        _cross_family_probe_record(
            decision_id="cross_probe_stale_success",
            source_id="historical_probe_stale_success",
            source_family_snapshot="adhd_aware_support+language_sensitive_support",
            target_id="historical_target_stale_success",
            target_family_snapshot="adhd_aware_support",
            observed_outcome_score=0.82,
            effective=True,
        ...
        _cross_family_probe_record(
            decision_id="cross_probe_recent_retry",
            source_id="historical_probe_recent_retry",
            source_family_snapshot="adhd_aware_support+language_sensitive_support",
            target_id="historical_target_recent_retry",
            target_family_snapshot="adhd_aware_support",
            observed_outcome_score=0.18,
            effective=False,
            timestamp=now - timedelta(hours=2),
    ...
    stale_success_candidate = next(
        item
        for item in candidates
        if item[0].profile_id == donor_cross_family.profile_id
    )
    assert stale_success_candidate[3]["edge_seeking_applied"] is True
...
def test_cross_family_probe_budget_accumulates_quality_weighted_success_bonus_slots() -> None:
    ...
    engine.decision_log = [
        _cross_family_probe_record(
            decision_id="cross_probe_fresh_success_a",
            source_id="historical_probe_fresh_success_a",
            source_family_snapshot="adhd_aware_support+language_sensitive_support",
            target_id="historical_target_fresh_success_a",
            target_family_snapshot="adhd_aware_support",
            observed_outcome_score=0.84,
            effective=True,
            timestamp=now - timedelta(hours=1),
        ),
        _cross_family_probe_record(
            decision_id="cross_probe_fresh_success_b",
            source_id="historical_probe_fresh_success_b",
            source_family_snapshot="adhd_aware_support+language_sensitive_support",
            target_id="historical_target_fresh_success_b",
            target_family_snapshot="adhd_aware_support",
            observed_outcome_score=0.8,
            effective=True,
            timestamp=now - timedelta(hours=2),
        ...
        _cross_family_probe_record(
            decision_id="cross_probe_recent_retry_c",
            source_id="historical_probe_recent_retry_c",
            source_family_snapshot="adhd_aware_support+language_sensitive_support",
            target_id="historical_target_recent_retry_c",
            target_family_snapshot="adhd_aware_support",
            observed_outcome_score=0.18,
            effective=False,
            timestamp=now - timedelta(hours=3),
