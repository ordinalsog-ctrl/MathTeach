...
class CalibrationContext(BaseModel):
    ...
    edge_policy_distribution: dict[str, int] = Field(
        default_factory=dict,
        description=(
            "Snapshot count of per-source edge policies for the currently "
            "selected path only. This resets for each new plan and is not a "
